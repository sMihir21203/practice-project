      ...
      <div className='mx-auto w-full max-w-screen-xl p-4 py-5 lg:py-8'>
        <div className='md:flex md:justify-between'>
          ...
          <div className='grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3'>
            <div>
              <h2 className='mb-6 text-sm font-semibold text-slate-950 uppercase'>
                Resources
              </h2>
              <ul className='text-slate-600 font-medium'>
                <li className='mb-4'>
                  <NavLink
                    ...
                    className={({
                      isActive,
                    }) => `block hover:underline duration-200
        ...
        <div className='sm:flex sm:items-center sm:justify-between'>
          ...
          <div className='flex mt-4 space-x-5 sm:justify-center sm:mt-0'>
            ...
            <Link to='#' className='text-gray-500 hover:text-slate-950'>
              <svg
                className='w-4 h-4'
                aria-hidden='true'
                xmlns='http://www.w3.org/2000/svg'
